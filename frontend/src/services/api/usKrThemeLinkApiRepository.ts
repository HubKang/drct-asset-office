...
export const usKrThemeLinkApiRepository = {
  overview: (window = 120, usMetric: "theme_strength" | "simple_return" = "theme_strength") =>
    apiRequest<UsKrThemeLinkOverview>(`/us-kr-theme-links/overview?window=${window}&us_metric=${usMetric}`, { cache: "no-store" }),
