...
import KmsKnowledgeDetailDrawer from "@/components/kms/KmsKnowledgeDetailDrawer";
...
function CatalogTab({ groups, reload }: { groups: ChartMarkerGroup[]; reload: () => Promise<void> }) {
  ...
  const [knowledgeDetailId, setKnowledgeDetailId] = useState<number | null>(null);
  ...
  return <>
    ...
    <KmsKnowledgeDetailDrawer itemId={knowledgeDetailId} onClose={() => setKnowledgeDetailId(null)} />
  </>;
}
