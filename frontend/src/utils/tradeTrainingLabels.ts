const TRADE_TRAINING_EVENT_LABELS: Record<string, string> = {
  ...
  PLANNED_BUY_EXECUTED: "계획대로 매수 실행",
  PLANNED_SELL_EXECUTED: "계획대로 매도 실행",
  ...
  FULL_STOP_PARTIAL_QUANTITY: "전량손절 계획 일부 매도",
  PARTIAL_STOP_FULL_QUANTITY: "분할손절 계획 전량 매도",
  STOP_AREA_BUY: "손절 구간 추가매수",
