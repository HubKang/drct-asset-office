...
export type ChartMarkerReviewResult = "S" | "F" | null;
...
export type ChartMarkerReviewChart = { stock_id:number; marker_date:string; marker_index:number|null; total_candles:number; available_before:number; available_after:number; requested_before:number; requested_after:number; candles:TrainingCandle[] };
