...
import ChartMarkerReviewPage from "@/pages/ChartMarkerReviewPage";
...
import RealtimeThemeTreemapPage from "@/pages/RealtimeThemeTreemapPage";
...
export const routeRegistry: RouteItem[] = [
  ...
  { routeKey: "drct-insight", path: "/drct-insight", title: "DrCT 실시간 인사이트", description: "D+1 테마 후보와 장전·장중 DrCT 정보를 종합한 실시간 인사이트", component: <DrctInsightPage /> },
  ...
  { routeKey: "drct-stock-signals", path: "/drct-stock-signals", title: "DrCT 종목별 마크 시그널", description: "차트 마크와 성공 패턴을 이용한 종목별 관찰 시그널", component: <DrctStockSignalsPage /> },
  ...
  { routeKey: "chart-marker-review", path: "/trading/chart-markers", title: "매매훈련 차트마커 복기", description: "차트마커 관리와 실제 사례 복기", component: <ChartMarkerReviewPage /> },
