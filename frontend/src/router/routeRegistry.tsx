...
export const routeRegistry: RouteItem[] = [
  ...
  { routeKey: "watchlist", path: "/watchlist", title: "관심종목 Pool", description: "분석 우선 대상 종목 Pool 관리", component: <WatchlistPage /> },
  {
  ...
  { routeKey: "schema-comments", path: "/schema-comments", title: "스키마 코멘트", description: "테이블/컬럼 주석 설명 데이터 사전", component: <SchemaCommentsPage /> },
  ...
  {
    routeKey: "classification-rules",
    path: "/classification-rules",
    title: "분류 규칙 관리",
    description: "뉴스와 공시의 태그/중요도/리스크 분류 기준을 관리합니다.",
    component: <ClassificationRulesPage />,
  },
  {
    routeKey: "settings",
    path: "/settings",
