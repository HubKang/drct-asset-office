...
KRX_OPEN_API_KEY = (os.getenv("KRX_OPEN_API_KEY") or KRX_OPEN_API_AUTH_KEY or os.getenv("KRX_API_KEY", "")).strip()
DATA_GO_KR_SERVICE_KEY = (os.getenv("DATA_GO_KR_SERVICE_KEY") or os.getenv("PUBLIC_DATA_API_KEY") or DATA_API_SERVICE_KEY).strip()
DATA_GO_KR_DECODING_KEY = os.getenv("DATA_GO_KR_DECODING_KEY", "").strip()
DATA_GO_KR_ENCODING_KEY = os.getenv("DATA_GO_KR_ENCODING_KEY", "").strip()
BOK_ECOS_API_KEY = (os.getenv("BOK_ECOS_API_KEY") or os.getenv("ECOS_API_KEY", "")).strip()
BOK_ECOS_BASE_URL = os.getenv("BOK_ECOS_BASE_URL", "https://ecos.bok.or.kr/api").strip()
BOK_ECOS_TIMEOUT_SECONDS = int(os.getenv("BOK_ECOS_TIMEOUT_SECONDS", "15"))
...
YOUTUBE_TRANSCRIPT_BYPASS_PROXY = os.getenv("YOUTUBE_TRANSCRIPT_BYPASS_PROXY", "true").strip().lower() in {"1", "true", "yes", "y", "on"}
YOUTUBE_TRANSCRIPT_PROVIDER = os.getenv("YOUTUBE_TRANSCRIPT_PROVIDER", "auto").strip().lower()
YOUTUBE_TRANSCRIPT_ENABLE_YTDLP = os.getenv("YOUTUBE_TRANSCRIPT_ENABLE_YTDLP", "true").strip().lower() in {"1", "true", "yes", "y", "on"}
YOUTUBE_TRANSCRIPT_LANGS = [
    lang.strip()
    for lang in os.getenv("YOUTUBE_TRANSCRIPT_LANGS", "ko-orig,ko,ko-KR,en,en-US").split(",")
    if lang.strip()
]
YOUTUBE_TRANSCRIPT_YTDLP_TIMEOUT_SECONDS = int(os.getenv("YOUTUBE_TRANSCRIPT_YTDLP_TIMEOUT_SECONDS", "60"))
YOUTUBE_TRANSCRIPT_MAX_CHARS = int(os.getenv("YOUTUBE_TRANSCRIPT_MAX_CHARS", "30000"))
YOUTUBE_TRANSCRIPT_YTDLP_JS_RUNTIMES = os.getenv("YOUTUBE_TRANSCRIPT_YTDLP_JS_RUNTIMES", "").strip()
ECONOMIC_BRIEFING_TRANSCRIPT_RETRY_COOLDOWN_MINUTES = int(os.getenv("ECONOMIC_BRIEFING_TRANSCRIPT_RETRY_COOLDOWN_MINUTES", "60"))
YOUTUBE_TRANSCRIPT_RATE_LIMIT_COOLDOWN_MINUTES = int(os.getenv("YOUTUBE_TRANSCRIPT_RATE_LIMIT_COOLDOWN_MINUTES", "360"))
