...
from backend.app.api.routes_drct_insight import router as drct_insight_router
...
from backend.app.core.database import ensure_drct_insight_candidate_schema, ensure_drct_stock_signal_schema, ensure_market_data_collection_schema, ensure_market_signal_schema, ensure_runtime_schema
...
ensure_drct_insight_candidate_schema()
...
app.include_router(drct_insight_router)
